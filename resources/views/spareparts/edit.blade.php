                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="ruk_no" name="ruk_no"
                            value="{{ old('ruk_no', $sparepart->ruk_no) }}" required
                            class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-indigo-500">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="jumlah_pesanan" class="block text-sm font-medium text-gray-700">Jumlah
                            Pesanan</label>
                    ...
                    <div class="form-group">
                        ...
                        <select id="cek" name="cek" required
                            class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-indigo-500">
                            <option value="1" {{ old('cek', $sparepart->cek) == 1 ? 'selected' : '' }}>Ya
                            </option>
                            <option value="0" {{ old('cek', $sparepart->cek) == 0 ? 'selected' : '' }}>Tidak
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="pic" name="pic"
                            value="{{ old('pic', $sparepart->pic) }}" required
                            class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-indigo-500">
                    </div>

                    <div class="form-group">
                        <label for="qr_code" class="block text-sm font-medium text-gray-700">QR Code
                            (Opsional)</label>
