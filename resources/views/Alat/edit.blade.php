...
@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-3xl shadow-xl p-8">
            ...
            <form method="POST" action="{{ route('alat.update', $alat->hashid) }}">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_alat" value="{{ old('nama_alat', $alat->nama_alat) }}"
                            class="w-full border border-gray-300 rounded-2xl px-5 py-3 focus:outline-none focus:ring-2 focus:ring-amber-500"
                            required>
                    </div>
                ...
                <div class="mt-10 flex gap-4">
                    <button type="submit"
                        class="flex-1 bg-amber-600 hover:bg-amber-700 text-white font-semibold py-4 rounded-2xl transition shadow-md">
