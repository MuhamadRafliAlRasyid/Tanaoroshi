        ...
        <div
            ...
            <div class="flex items-center gap-3 mb-8">
                ...
                <div>
                    ...
                    <p class="text-gray-600">{{ $data->alat->nama_alat ?? '-' }}</p>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('kalibrasis.update', $data->hashid) }}">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="keterangan" rows="4"
                            class="w-full border border-gray-200 dark:border-gray-700 dark:border-gray-700 dark:border-gray-700 dark:border-gray-700 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-amber-400 transition">{{ old('keterangan', $data->keterangan) }}</textarea>
                    </div>
                </div>

                <div class="mt-10 flex gap-4 justify-end">
                    <a href="{{ route('kalibrasis.show', $data->hashid) }}"
